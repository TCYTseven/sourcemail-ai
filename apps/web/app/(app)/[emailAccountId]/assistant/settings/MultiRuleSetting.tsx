    ...
    <SettingCard
      title={
        <div className="flex items-center gap-1.5">
          ...
          <TooltipExplanation
            side="top"
            text="Turning this off stops the AI from intentionally choosing multiple custom rules for one email. LassoMail can still apply more than one rule in a few special cases."
          />
        </div>
      }
