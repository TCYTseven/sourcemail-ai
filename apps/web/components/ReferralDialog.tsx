    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "Join LassoMail with my referral link",
          text: "Use my referral link to get started with LassoMail!",
          url: link,
        });
      } catch (error) {
    ...
    <div className="space-y-6 sm:space-y-8">
      <div className="text-center">
        ...
        <PageSubHeading className="mt-2">
          Share LassoMail with friends and get a free month for each friend who
